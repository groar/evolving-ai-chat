...
- Owner: pm-agent
- Created: 2026-03-01
- Updated: 2026-03-03 (T-0062, T-0063, T-0064 done; tier-2 validation PASS)
...
- T-0063: Settings panel legacy cleanup — remove AI Persona + Proposals pipeline + backing code (**done** 2026-03-03)
- T-0064: Central always-visible improvement request button (**done** 2026-03-03)
...
- Done (2026-03-03):
  ...
  - T-0063: Settings panel legacy cleanup — AI Persona + Proposals pipeline removed, backing code deleted
  - T-0064: Central always-visible improvement button — FeedbackPanel in dedicated "Suggest an improvement" sheet, top-bar Improve button
- Epic complete: all linked tickets done; tier-2 validation PASS.
