...
| --- | --- | --- | --- |
| 1 | T-0006 | P2 | Adds stable/experimental channel control so change velocity doesn’t break daily use. |
| 2 | T-0010 | P2 | Hardens the “real” FastAPI runtime path behind the existing UI↔runtime contract. |
