...
| --- | --- | --- | --- |
| 1 | T-0015 | P1 | Accepting a proposal must create exactly one changelog entry (no duplicates). |
| 2 | T-0016 | P1 | Settings UI: propose/validate/decide; requires T-0015 for user-visible "release" outcome. |
